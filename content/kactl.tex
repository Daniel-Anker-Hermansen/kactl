...
\team{\texttt{[\&](auto \&self, i64 i) -> void \{ vis[i] = 1; f(i); for (i64 n : adj[i]) if (!vis[n]) self(self, n); \};}}{Daniel Anker Hermansen, Frederik Vase Haraldsson, Sebastian Meineche Falk}
